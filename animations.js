    ...
    function createFlyingSwastikas() {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            swastika.style.cssText = `
                ...
                opacity: 0.3;
                text-shadow: 0 0 10px rgba(234, 141, 247, 0.8);
                pointer-events: none;
                user-select: none;
    ...
    function initInteractiveEffects() {
        ...
        socialLinks.forEach(link => {
            ...
            link.addEventListener('mouseenter', function() {
                ...
                this.style.boxShadow = '0 8px 25px rgba(234, 141, 247, 0.3)';
            });
            
            link.addEventListener('mouseleave', function() {
                this.style.transform = 'scale(1) translateY(0)';
                this.style.boxShadow = '0 5px 15px rgba(234, 141, 247, 0.2)';
            });
            ...
            link.addEventListener('click', function(e) {
                ...
                ripple.style.cssText = `
                    position: absolute;
                    border-radius: 50%;
                    background: rgba(234, 141, 247, 0.4);
                    transform: scale(0);
